...
const HomeRecipeOptions = createSlice({
  name: "searchitems",
  initialState,
  reducers: {
    loadhomerecipeoptions(state, action) {
      state.data = action.payload;
    },
  },
});

export const { loadhomerecipeoptions } = HomeRecipeOptions.actions;
export default HomeRecipeOptions.reducer;
